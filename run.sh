...
epoch=5
bsz=16
head_num=11     # hyperparameter of the dual-bert-one2mnay: 11 heads means there are 1 groundtruths and 10 retrieved candidates
inf_bsz=64
post_bsz=64
post_epoch=2
post_max_len=512
...
datasets=(ecommerce douban ubuntu lccc)
chinese_datasets=(douban ecommerce lccc)
# ========== metadata ========== #
