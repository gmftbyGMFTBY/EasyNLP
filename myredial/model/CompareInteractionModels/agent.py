...
class CompareInteractionAgent(RetrievalBaseAgent):
    ...
    def __init__(self, vocab, model, args):
        ...
        if args['model'] in ['dual-bert-scm', 'dual-bert-scm-hn', 'dual-bert-scm-hn-mch', 'dual-bert-scm-hn-with-easy']:
    ...
    def load_model(self, path):
        ...
        if self.args['mode'] == 'train':
            if self.args['model'] in ['dual-bert-comp-hn', 'dual-bert-comp', 'dual-bert-compare', 'dual-bert-scm', 'dual-bert-scm-hn', 'dual-bert-scm-hn-mch', 'dual-bert-scm-hn-with-easy']:
