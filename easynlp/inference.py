...
def inference(**args):
    ...
    elif work_mode in ['dialog-context']:
        # gray and gray-one2many will use the checkpoint generated by the context work_mode
        agent.inference_dialog_context(data_iter, size=args['cut_size'])
...
if __name__ == "__main__":
    ...
    if args['work_mode'] in ['writer-inference']:
        ...
        da_strategy(args)
    elif args['work_mode'] in ['response', 'wz-simcse', 'knnlm', 'dialog-context']:
