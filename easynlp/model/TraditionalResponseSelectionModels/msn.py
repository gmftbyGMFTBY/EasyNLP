...
class MSN(nn.Module):
    ...
    def __init__(self, **args):
        ...
        self.word_embedding = nn.Embedding(
            num_embeddings=args['vocab_size'], embedding_dim=200, 
        )
    ...
    def forward(self, batch):
        ...
        for idx in range(candi_num):
            ...
            one_score = self.forward_step(utterance, one_batch_response)
    ...
    def predict(self, batch):
        ...
        '''
        batch_score = self.forward(batch)
        return batch_score
